        ...
        createChannel.mutate(
            {
                ...
                cache_ratio_enabled: formData.cache_ratio_enabled,
                cache_ratio_min: formData.cache_ratio_min,
                cache_ratio_max: formData.cache_ratio_max,

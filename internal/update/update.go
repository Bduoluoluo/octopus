...
const (
	updateUrl    = "https://github.com/" + conf.GitHubRepository + "/releases/latest/download"
	updateApiUrl = "https://api.github.com/repos/" + conf.GitHubRepository + "/releases/latest"
)

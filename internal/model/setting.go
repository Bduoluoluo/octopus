...
const (
	...
	SettingKeyRelayLogMaxDBSizeMB              SettingKey = "relay_log_max_db_size_mb"
...
func DefaultSettings() []Setting {
	return []Setting{
		...
		{Key: SettingKeyRelayLogMaxDBSizeMB, Value: "1024"},
...
func (s *Setting) Validate() error {
	switch s.Key {
	case SettingKeyRelayLogMaxDBSizeMB:
		return validateIntRange(s.Value, 1, 1048576)
	...
	case SettingKeySSEHeartbeatInterval, SettingKeySSEPreStreamHeartbeatDelay, SettingKeyRelayRequestTimeout:
		...
		return nil
	case SettingKeyRelayLogKeepEnabled, SettingKeyResponsesWSEnabled, SettingKeyGroupHealthEnabled, SettingKeyStatsSiteModelBackfilled, SettingKeyOutlierRetireEnabled, SettingKeyAutoGroupCreateMissingEnabled, SettingKeyAutoGroupNormalizeEnabled:
